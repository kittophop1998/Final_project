...
<td> </td>
<td> </td>
<tr height="25" bgcolor="#1881fe"><td align="center"><a href="datastyear.php"><font color="white">ระดับชั้น</font></a></td></tr>
<td> </td>
<td> </td>
<tr height="25" bgcolor="#1881fe"><td align="center"><a href="datastroom.php"><font color="white">ระดับห้อง</font></a></td></tr>
<td> </td>
<td> </td>
    ...
    <body>
        <div class="container">
            ...
            <form action="" method="GET">
                <input type="text" placeholder="กรุณากรอกรหัสนักเรียน" name="search">&nbsp;
