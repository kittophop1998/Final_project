...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" bgcolor="#FFFFFF" text="#000000" alink="#003399" link="#003399" vlink="#003399">
    <img src= "https://www.img.in.th/images/9fcf3f685b7d75520d2230401b80e1e9.png" width="100%" height="50%">
        ...
        <?php
            ...
            if(!empty($_REQUEST['submit']) && $_REQUEST['submit'] == 'ตกลง'){
                $sql = "INSERT IGNORE INTO `l_leave` (`student_number`,`date_leave`, `title_leave`, `content_leave` , `accept`) VALUES ('".$student_number."','". $_REQUEST['date']."','".$_REQUEST['cars']."','".$_REQUEST['message']."','รอการอนุมัติ')";
                $r = $conn->query($sql);
                ...
                $sql1 = "SELECT * FROM student WHERE student_number = '".$student_number."' ";
                $r = $conn->query($sql1);
                $row = $r->fetch_array();
    ...
    <form action="leave.php" method="get">
            ...
            <?php
                $sql2 = "SELECT * FROM l_leave INNER JOIN student ON student.student_number = l_leave.student_number WHERE student.student_number = '".$student_number."' ";
                $l = $conn->query($sql2);
