...
<tr height="50" bgcolor="#FF3366"><td align="center"> <font color="white"> ข้อมูลนักเรียน</font></td></tr>
<td> </td>
<td> </td>
<tr height="25" bgcolor="#FF0000"><td align="center"><a href="datast.php"><font color="white">กลับ</font></a></td></tr>
<tr><td>
<center>
...
if( isset($_GET['search']) ){
    ...
    $sql = "SELECT * FROM student WHERE student_year ='$id'";
}
...
<html>
    ...
    <body>
        <div class="container">
            <label>ค้นหารายชั้นปี</label>
            <form action="" method="GET">
                <input type="text" placeholder="กรุณากรอกชั้นปี" name="search">&nbsp;
