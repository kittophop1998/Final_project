...
if( isset($_GET['search_year'], $_GET['search_room']) ){
    $year = mysqli_real_escape_string($con, htmlspecialchars($_GET['search_year']));
    $room = mysqli_real_escape_string($con, htmlspecialchars($_GET['search_room']));

    $sql = "SELECT * FROM student WHERE student_year ='$year' and student_room ='$room'";
}
...
<html>
    ...
    <body>
        <div class="container">
            <label>ค้นหารายห้อง</label>
            <form action="" method="GET">
                <input type="text" placeholder="กรุณากรอกชั้น" name="search_year">&nbsp;
                <input type="text" placeholder="กรุณากรอกห้อง" name="search_room">&nbsp;
