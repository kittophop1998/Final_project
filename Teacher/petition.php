    ...
    <img src= "https://www.img.in.th/images/9fcf3f685b7d75520d2230401b80e1e9.png" width="100%" height="50%">
        <table width="100%" height="50%" border="1" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <!-- <tr height="25" bgcolor="#1881fe"><td align="center"><a href="deteil_leave.php"><font color="white">รายละเอียดการลา</font></a></td></tr> -->
        ...
        <form action="#" method="post">
            <table>
                <tr>
                    <td>รหัสนักเรียน : <input type="text" name="student_number"></td>
                    <td><input type="submit" name="submit" value="ตรวจสอบ"></td>
                </tr>
            </table>
        </form>
        <hr>
        ...
        <?php
            if(!empty($_POST['submit']) && $_POST['submit'] == 'ตรวจสอบ'){
        ...
        <form action="petition.php" method="get">
            ...
            <table class="simply">
                ...
                <tr>
                    <td><font size="4">เหตุผลที่ขอเปลี่ยนสถานะ : </font></td>
                    <td>
        ...
        <?php
                $sql2 = "SELECT * FROM status INNER JOIN beacon_student ON beacon_student.beacon = status.beacon INNER JOIN student ON student.student_number = beacon_student.student_number WHERE student.student_number = '".$_REQUEST['student_number']."' ORDER BY date DESC LIMIT 7";
                $l = $conn->query($sql2);
