<html>
    ...
    <table width="100%" height="50%" border="1" cellpadding="0" cellspacing="0">
        ...
        <br>
        <center><font size="5">รายชื่อบุคคลยื่นการลา</font></center>
        <br>
        <br>
        <from action='admin_leave' method='post'>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row["content_leave"]?></td>
                    <!-- <td><input class='w3-button w3-green' type='button' name='submit' value='ยืนยัน'></td> -->
                    <td><a href='admin_leave_comfirm.php?beacon=<?php echo $row[0]?>&&date=<?php echo $row[2]?>&&student_number=<?php echo $row[5]?>'><input class='w3-button w3-green' type='button' name='submit' value='ยืนยัน'></a></td>
            <?php
                }
            ?>
            </table>
