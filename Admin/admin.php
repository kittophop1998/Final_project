<html>
    ...
    <!-- <script language="javascript">
        ...
        var password1="09876";
        var password2="11111";
        var name = prompt("กรุณาพิมพ์ PASSWORD","password");
        if(name == password || name == password1 || name == password2){
            (confirm("PASSWORD ถูกต้องครับ"))
    ...
    <table width="100%" height="50%" border="1" cellpadding="0" cellspacing="0">
        ...
        <br>
        <center><font size="5">รายชื่อคนที่ขาด วันที่ : <?php echo date("Y-m-d")?></font></center><br>
        <div id="autodata"></div>
